...
- **Keep comments brief.** A line or two saying what isn't obvious from the code; don't restate the code, enumerate every related value, or explain the reasoning at essay length.

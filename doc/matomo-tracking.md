...
| `DocumentExport` | `export` | format (pdf/svg/png/jpeg/webp/webp-lossy) | `MapExport`/`export` | [`exportMapToDocument.ts`](../src/features/mapToDocumentExport/model/exportMapToDocument.ts) |

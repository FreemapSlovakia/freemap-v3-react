...
| tail | both | **A watched device's trace can be kept** — the live-tracking toolbar copies what a device has travelled so far into Tracks and data (where the profile, colorizing and every export work on it) or into an editable drawing. The device goes on being watched either way. | `32a0872b` | |

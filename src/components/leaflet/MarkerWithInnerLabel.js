...
export default class MarkerWithInnerLabel extends React.Component {
  static propTypes = {
    ...Marker.propTypes,
  ...
  render() {
    ...
    const html = `
      <svg style="enable-background:new 0 0 512 512;" x="0px" y="0px" viewBox="0 0 310 512" xmlns="http://www.w3.org/2000/svg">
        ...
        ${(label || image || faIcon) ? '<ellipse cx="154.12" cy="163.702" rx="119.462" ry="119.462" style="stroke-width: 10; stroke-opacity: 0.6; fill: url(#gradient-2);"/>' : ''}

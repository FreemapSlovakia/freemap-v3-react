...
import { authLoginWithOsm, authLoginWithFacebook, authLoginClose } from 'fm3/actions/authActions';

function LoginModal({ onClose, onLoginWithFacebook, onLoginWithOsm }) {
  return (

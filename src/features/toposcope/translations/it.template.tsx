...
const it: DeepPartialWithRequiredObjects<ToposcopeMessages> = {
  ...
  settings: {
    ...
    line2: 'Seconda riga',
    lineHint:
      'Disponibili: {label}, {elevation}, {elevation_ft}, {distance}, {distance_mi}, {azimuth}, {location} e {property:nome} per qualsiasi proprietà del punto. Un valore mancante porta via anche il suo separatore.',
    placeholders:

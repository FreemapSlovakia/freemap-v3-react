...
const fr: DeepPartialWithRequiredObjects<ToposcopeMessages> = {
  ...
  settings: {
    ...
    lineHint:
      "Disponibles : {label}, {elevation}, {elevation_ft}, {distance}, {distance_mi}, {azimuth}, {location} et {property:nom} pour n'importe quelle propriété du point. Une valeur manquante emporte son séparateur.",
    placeholders:

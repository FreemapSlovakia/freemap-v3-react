...
const sk: DeepPartialWithRequiredObjects<ToposcopeMessages> = {
  ...
  settings: {
    ...
    line2: 'Druhý riadok',
    lineHint:
      'K dispozícii: {label}, {elevation}, {elevation_ft}, {distance}, {distance_mi}, {azimuth}, {location} a {property:nazov} pre ľubovoľnú vlastnosť bodu. Chýbajúca hodnota si so sebou vezme aj oddeľovač.',
    placeholders:

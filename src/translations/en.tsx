    ...
    uploadModal: {
      ...
      rules: `
        ...
        <ul>
          ...
          <li>Captions or comments that do not directly relate to the content of uploaded photos or contradict generally accepted principles of civilized coexistence will be removed. Violators of this rule will be warned, and in case of repeated violations, their account in the application may be canceled.</li>

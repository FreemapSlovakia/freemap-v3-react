...
export default {
  ...
  main: {
    ...
    devInfo: 'Toto je testovací verze portálu Freemap Slovakia. Pro ostrou verzi přejděte na <a href="https://www.freemap.sk/">www.freemap.sk</a>. ',
  ...
  objects: {
    type: 'Typ',
    lowZoomAlert: 'Vyhledávání míst je možné až od přiblížení úrovně 12.',
  ...
  mapLayers: {
    missingStravaAuth: 'Prosím prihláste sa najprv na strava.com a obnovte túto stránku.', // TODO translate
    layers: 'Vrstvy',
    ...
    attr: {
      ...
      osmData: '© přispěvatelé OpenStreetMap',
      srtm: '© SRTM',
      hot: '© Humanitární tým OpenStreetMap',
    },
  },

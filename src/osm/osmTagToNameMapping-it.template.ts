...
export const osmTagToNameMapping: DeepPartial<OsmTagToNameMapping> = {
  ...
  amenity: {
    ...
    vending_machine: {
      ...
      vending: {
        animal_feed: 'Distributore di mangime',
  ...
  barrier: {
    ...
    bus_trap: 'Varco per autobus',
    cable_barrier: 'Barriera cavi',
    cattle_grid: 'Griglia antibestiame',
    chain: 'Catena',
    chicane: 'Chicane',
    city_wall: 'Mura cittadine',
    cycle_barrier: 'Barriera per ciclisti',
    ditch: 'Fossato',
    entrance: 'Entrata',
    fence: 'Recinzione',
    'full-height_turnstile': 'Tornello a tutta altezza',
    gate: 'Cancello',
    guard_rail: 'Guardrail',
    hampshire_gate: 'Cancello di filo',
    handrail: 'Corrimano',
    hedge: 'Siepe',
    height_restrictor: 'Limitatore di altezza',
    jersey_barrier: 'Barriera new jersey',
    kerb: 'Cordolo',
    kissing_gate: 'Cancelletto antibestiame',
    lift_gate: 'Ascensore',
    log: 'Tronco',
    motorcycle_barrier: 'Barriera per motocicli',
    planter: 'Fioriera',
    rope: 'Corda',
    sally_port: 'Postierla',
    sliding_gate: 'Cancello scorrevole',
    spikes: 'Dissuasori a punte',
    stile: 'Scaletta di passaggio',
    swing_gate: 'Cancello a battente',
    toll_booth: 'Casello',
    turnstile: 'Tornello',
    wall: 'Muro',
    wicket_gate: 'Cancelletto',
    yes: 'Barriera',
  ...
  genus: {
    ...
    Rosa: {
      '*': 'Rosa',
      species: { 'Rosa canina': 'Rosa canina' },
    },
    Rubus: {
      '*': 'Rubus',
      species: {
    ...
    Salix: {
      '*': 'Salice',
      species: { 'Salix babylonica': 'Salice piangente' },
    },
    Sambucus: 'Sambuco',
    Sequoiadendron: 'Sequoia gigante',
    Sorbus: {
      '*': 'Sorbo',
      species: { 'Sorbus aria': 'Sorbo montano' },
    },
    Spiraea: 'Spirea',
  ...
  landuse: {
    ...
    orchard: {
      '*': 'Frutteto',
      trees: {
        almond_trees: 'Mandorleto',
        apple_trees: 'Meleto',
        apricot_trees: 'Albicoccheto',
        blueberry_plants: 'Mirtilleto',
        cherry_trees: 'Ciliegeto',
        chestnut_trees: 'Castagneto',
        christmas_trees: 'Piantagione di alberi di Natale',
        fig_trees: 'Ficheto',
        hazel_plants: 'Noccioleto',
        hop_plants: 'Luppoleto',
        kiwi_plants: 'Actinidieto',
        lemon_trees: 'Limoneto',
        oak_trees: 'Querceto',
        olive_trees: 'Oliveto',
        orange_trees: 'Aranceto',
        peach_trees: 'Pescheto',
        pear_trees: 'Pereto',
        pistachio_trees: 'Pistacchieto',
        plum_trees: 'Susineto',
        walnut_trees: 'Noceto',
      },
    },
  ...
  zoo: {
    aquarium: 'Acquario',
    aviary: 'Voliera',
    birds: 'Parco ornitologico',
    butterfly: 'Casa delle farfalle',
    enclosure: 'Recinto per animali',
    falconry: 'Falconeria',
    petting_zoo: 'Zoo per bambini',
    reptile: 'Rettilario',
    safari_park: 'Safari park',
    terrarium: 'Terrario',
    wildlife_park: 'Parco faunistico',
  },
};

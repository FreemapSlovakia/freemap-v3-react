...
export const osmTagToNameMapping: DeepPartial<OsmTagToNameMapping> = {
  ...
  amenity: {
    ...
    vending_machine: {
      vending: {
        animal_feed: 'Állateledel-automata',
  ...
  barrier: {
    ...
    cattle_grid: 'Marharács',
    chain: 'Lánc',
    chicane: 'Forgalomlassító terelés',
    city_wall: 'Városfal',
    cycle_barrier: 'Kerékpáros akadály',
    ditch: 'Árok (akadály)',
    entrance: 'Átjárás falon',
    fence: 'Kerítés',
    'full-height_turnstile': 'Teljes magasságú forgókapu',
    gate: 'Kapu',
    guard_rail: 'Szalagkorlát',
    hampshire_gate: 'Drótkapu',
    handrail: 'Kapaszkodó korlát',
    hedge: 'Sövény (akadály)',
    height_restrictor: 'Magasságkorlátozó',
    jersey_barrier: 'Betonterelő',
    kerb: 'Járdaszegély',
    kissing_gate: 'Terelőkapu',
    lift_gate: 'Emelkedő sorompó',
    log: 'Rönk',
    motorcycle_barrier: 'Motorkerékpár-akadály',
    planter: 'Növénytartó',
    rope: 'Kötél',
    sally_port: 'Kitörőkapu',
    sliding_gate: 'Tolókapu',
    spikes: 'Tüskesor',
    stile: 'Kerítésátjáró',
    swing_gate: 'Elforduló soromó',
    toll_booth: 'Fizetőkapu',
    turnstile: 'Forgóajtó',
    wall: 'Fal',
    wicket_gate: 'Kiskapu',
    yes: 'Akadály',
  ...
  genus: {
    ...
    Melia: 'Kínafa',
    Mespilus: 'Naspolya',
    Metasequoia: 'Kínai mamutfenyő',
    Morus: 'Eperfa',
    Nerium: 'Leander',
    Olea: 'Olajfa',
    Ostrya: 'Komlógyertyán',
    Parrotia: 'Vasfa',
    Paulownia: 'Császárfa',
    ...
    Prunus: {
      '*': 'Prunus',
      species: {
        'Prunus armeniaca': 'Kajszibarackfa',
        'Prunus avium': 'Cseresznyefa',
        'Prunus cerasifera': 'Cseresznyeszilva',
        'Prunus cerasus': 'Meggyfa',
        'Prunus domestica': 'Szilvafa',
        'Prunus dulcis': 'Mandulafa',
        'Prunus laurocerasus': 'Babérmeggy',
        'Prunus padus': 'Zselnicemeggy',
        'Prunus persica': 'Őszibarackfa',
    ...
    Rosa: {
      '*': 'Rózsa',
      species: { 'Rosa canina': 'Gyepűrózsa' },
    },
    Rubus: {
      '*': 'Rubus',
      species: {
    ...
    Salix: {
      '*': 'Fűz',
      species: { 'Salix babylonica': 'Szomorúfűz' },
    },
    Sambucus: 'Bodza',
    Sequoiadendron: 'Óriás mamutfenyő',
    Sorbus: {
      '*': 'Berkenye',
      species: { 'Sorbus aria': 'Lisztes berkenye' },
    },
    Spiraea: 'Gyöngyvessző',
    Styphnolobium: 'Japánakác',
    Syringa: 'Orgona',
    Taxus: 'Tiszafa',
    Thuja: 'Tuja',
    Tilia: 'Hárs',
    ...
    Vaccinium: {
      '*': 'Áfonya',
      species: {
        'Vaccinium myrtillus': 'Fekete áfonya',
  ...
  landuse: {
    ...
    orchard: {
      '*': 'Gyümölcsös',
      trees: {
        almond_trees: 'Mandulás',
        apple_trees: 'Almás',
        apricot_trees: 'Kajszibarackos',
        blueberry_plants: 'Áfonyaültetvény',
        cherry_trees: 'Cseresznyés',
        chestnut_trees: 'Gesztenyés',
        christmas_trees: 'Karácsonyfa-ültetvény',
        fig_trees: 'Fügés',
        hazel_plants: 'Mogyorós',
        hop_plants: 'Komlóskert',
        kiwi_plants: 'Kiviültetvény',
        lemon_trees: 'Citromliget',
        oak_trees: 'Tölgyültetvény',
        olive_trees: 'Olajfaliget',
        orange_trees: 'Narancsliget',
        peach_trees: 'Őszibarackos',
        pear_trees: 'Körtés',
        pistachio_trees: 'Pisztáciaültetvény',
        plum_trees: 'Szilvás',
        walnut_trees: 'Diós',
      },
    },
  ...
  zoo: {
    ...
    enclosure: 'Kifutó',
    falconry: 'Solymászat',
    petting_zoo: 'Simogató állatkert',
    reptile: 'Hüllőház',
    safari_park: 'Szafaripark',
    terrarium: 'Terrárium',
    wildlife_park: 'Vadaspark',
  },
};

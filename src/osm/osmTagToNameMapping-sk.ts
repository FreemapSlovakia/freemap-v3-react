...
export const osmTagToNameMapping: OsmTagToNameMapping = {
  ...
  amenity: {
    ...
    bicycle_repair_station: 'Stojan pre opravu bicyklov',
    ...
    device_charging_station: 'Nábíjacia stanica elektrovozidiel',
  ...
  shop: {
    ...
    craft: 'Obchod s vybavením pre umelcov a remeselníkov',
    curtain: 'Predajňa záclon a závesov',
    dairy: 'Mlečné výrobky',
    deli: 'Lahôdky',
    ...
    gift: 'Predaj darčekových predmetov',
    glaziery: 'Sklenár',
    ...
    pet_grooming: 'Salón pre miláčikov',

...
O **plné vrátenie peňazí môžete požiadať do 14 dní** od:
...
# Právo na odstúpenie od zmluvy (spotrebitelia v EÚ)

Ak ste spotrebiteľom v Európskej únii, máte zákonné právo odstúpiť od kúpy digitálneho obsahu a služieb do 14 dní. Vyššie opísané obdobie bez udania dôvodu toto právo napĺňa alebo prekračuje. Naše 14-dňové vrátenie peňazí platí bez ohľadu na to, či ste prémiové funkcie už začali používať.

# Po uplynutí 14 dní

Po uplynutí 14 dní od kúpy alebo obnovenia je daná platba spravidla **nevratná**, pretože Predplatné Vám bolo na príslušné obdobie sprístupnené.

Týmto nie sú dotknuté Vaše záväzné zákonné práva. Najmä môžete mať aj naďalej nárok na nápravu (vrátane vrátenia peňazí), ak je Služba chybná, nezodpovedá opisu alebo inak nie je v súlade s týmito Podmienkami či platnými predpismi o ochrane spotrebiteľa. Vratky mimo štandardného obdobia môžeme poskytnúť aj podľa Nášho uváženia, napríklad pomerne, ak Predplatné ukončíme bez Vášho zavinenia.

# Kredity

Kredity sú predplatený zostatok používaný na funkcie účtované podľa spotreby (v súčasnosti export máp na offline použitie). Pri Kreditoch sa 14-dňové vrátenie peňazí vzťahuje na **nepoužitý** zostatok: do 14 dní od kúpy Kreditov môžete požiadať o vrátenie peňazí za Kredity, ktoré ste ešte neminuli. Už minuté Kredity sú **nevratné**, pretože príslušný digitálny obsah už bol dodaný. Kredity nemajú obmedzenú platnosť (neexspirujú).
...
Vrátenie peňazí za uskutočnenú platbu je oddelené od zrušenia budúcich obnovení. Ak chcete zabrániť obnoveniu Predplatného, zrušte ho spôsobom opísaným v [Obchodných podmienkach](#document=termsOfService). Zrušenie zastaví budúce platby, no samo o sebe nevracia už uskutočnenú platbu — na to použite vyššie uvedený postup vrátenia peňazí.

# Zmeny týchto Zásad

Tieto Zásady vrátenia peňazí môžeme z času na čas aktualizovať. Aktualizovanú verziu zverejníme na tejto stránke a aktualizujeme dátum „Naposledy aktualizované“. Zmeny neznižujú práva na vrátenie peňazí pri už uskutočnených kúpach.
